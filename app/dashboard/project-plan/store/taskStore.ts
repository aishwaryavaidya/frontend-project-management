...
import { Task, TaskUpdate, STAGES, PRODUCTS } from '@/app/dashboard/project-plan/types/task';
import { 
  ...
  findAllChildTasks, 
  updateParentStatus 
} from '@/app/dashboard/project-plan/lib/taskUtils';
...
export const useTaskStore = create<TaskState>((set, get) => ({
  ...
  setTasks: (tasks) => {
    if (!Array.isArray(tasks)) {
      console.warn('setTasks received non-array value:', tasks);
      return;
    }
