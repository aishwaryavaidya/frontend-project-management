...
const page = () => {
  ...
  return (
    ...
    <div>
      <div className="flex justify-between pl-2 w-full bg-white rounded-lg p-1 dark:bg-black border-b" style={{height: "370px", maxWidth: "calc(100vw - 70px)"}}>
              <div className="flex max-w-full"> <SummaryTable /> </div>
              {/* <div className="flex w-full h-80 mt-2 ml-2.5"> <UpscrollingFeed/> </div> */}
      </div>

      <div className="flex mt-4 justify-center gap-2 items-start rounded-lg shadow-md dark:bg-black" style={{maxWidth: "calc(100vw - 70px)"}}>
          {/* Project Phases Overview */}
          <div className="flex flex-col items-center w-1/2 z-0">
              <h2 className="text-base font-semibold text-center mb-2">Project Phases Overview</h2>
              <PhaseChart />
          </div>

          {/* Effort Estimation by Customer */}
          <div className="flex flex-col items-center w-1/2 z-0 overflow-visible">
